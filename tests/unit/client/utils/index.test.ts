...
describe('Utilities', () => {
  describe('getNoteTitle', () => {
    it(`should return 45 characters`, () => {
  ...
  and something else`
    ...
    it(`should ignore newlines in the beginning`, () => {
      const note = `
  ...
  describe('getWebsiteTitle', () => {
    it(`should display the folder name followed by the app name`, () => {
    ...
    it(`should display the category name followed by the app name`, () => {
      const category = {
        id: '123',
        name: 'Recipes',
        draggedOver: false,
  ...
  describe('getActiveNoteFromShortUuid', () => {
    it(`should get active note from short`, () => {
    ...
    it(`should get active note from short with braces`, () => {
      const activeNoteId = '6ec0bd7f-11c0-43da-975e-2a8ad9ebae0b'
      const shortActiveNoteId = '{{6ec0bd}}'
      const otherNoteId = '710b962e-041c-11e1-9234-0123456789ab'
    ...
    it(`should not get active note if not present`, () => {
      const shortActiveNoteId = '6ec0bd'
